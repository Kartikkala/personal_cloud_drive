export class FileObject{
    ...
    constructor(userDirName, userDirMountPath, totalUserSpaceInBytes)
    {
        if(!userDirName || !userDirMountPath || !totalUserSpaceInBytes)
        {
    ...
    async #checkPermission(targetPath){
        ...
        try{
            let requestedPath = path.join(this.#userDirMountPath, this.#userDirName ,targetPath)
            ...
            permissionObject.permission = fullPath.startsWith(path.join(this.#userDirMountPath, this.#userDirName))
